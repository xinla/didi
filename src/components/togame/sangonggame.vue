...
<div class="_2FVVn">
      ...
      <div class="_1YNLs _1ntud">
        <div class="_27QHH">
          ...
          <div class="_2jbzU">
            ...
            <div class="_2e_lZ">{{desk.max_bet?desk.max_bet:''}}</div>
          </div>
          <div class="_2jbzU">
        ...
        <div class="_2fHau">
          <div class="hqa41">
            <template v-for='(one,index,key) in leijidata.history_average'>
              <div class="_2_lIy"
                   :key='index'>
                <div class="_34U0X">{{key+1}}</div>
                <div class="EjgZS">{{one}}</div>
                <div class="_1TDGD">

                  <template v-for='(oneitem,itemindex) in leijidata.history[index]'>
  ...
  <!-- 发牌 -->
   <div class="oFCwz" v-if='desk_status[gameId]&&desk_status[gameId]["text"]=="结算中"?true:false '>
   <div class="_1DTtZ">
    <div class="_3495p">
     <div class="_19yHq IBoJx">
      <div class="LKrbW">
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][1][1]' ></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][1][2]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][1][3]'></div>
      </div>
      <div class="kUfzd" v-if='desk_pai[gameId][1][3]?true:false' :class='iszhuanged==1?  "_2Ntdh":""'>
       <span class="_3PXnW"><span>公</span><span class="_2528t"></span>{{desk_pai[gameId][1]['gong']}}<span>点</span></span>
      </div>
     </div>
     <div class="_19yHq _297ix">
      <div class="LKrbW">
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][2][1]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][2][2]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][2][3]'></div>
      </div>
      <div class="kUfzd" v-if='desk_pai[gameId][2][3]?true:false' :class='iszhuanged==2?  "_2Ntdh":""'>
       <span class="_3PXnW">{{desk_pai[gameId][1]['dian']}}<span>点</span></span>
      </div>
     </div>
     <div class="_19yHq _5ekkN">
      <div class="LKrbW">
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][3][1]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][3][2]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][3][3]'></div>
      </div>
      <div class="kUfzd" v-if='desk_pai[gameId][3][3]? true:false' :class='iszhuanged==3?  "_2Ntdh":""'>
       <span class="_3PXnW"><span>公</span><span class="_2528t"></span>{{desk_pai[gameId][1]['gong']}}<span>点</span></span>
      </div>
     </div>
     <div class="_19yHq CP_N5">
      <div class="LKrbW">
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][4][1]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][4][2]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][4][3]'></div>
      </div>
      <div class="kUfzd" v-if='desk_pai[gameId][4][3]?true:false' :class='iszhuanged==4?  "_2Ntdh":""'>
       <span class="_3PXnW">{{desk_pai[gameId][1]['dian']}}<span>点</span></span>
      </div>
     </div>
     <div class="_19yHq _1DEQ8">
      <div class="LKrbW">
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][5][1]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][5][2]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][5][3]'></div>
      </div>
      <div class="kUfzd" v-if='desk_pai[gameId][5][3]?true:false' :class='iszhuanged==5?  "_2Ntdh":""'>
       <span class="_3PXnW"><span>公</span><span class="_2528t"></span>{{desk_pai[gameId][1]['gong']}}<span>点</span></span>
      </div>
     </div>
     <div class="_19yHq uEIjy">
      <div class="LKrbW">
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][6][1]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][6][2]'></div>
       <div class="_2I7lr  _2iVV0" :class='desk_pai[gameId][6][3]'></div>
      </div>
      <div class="kUfzd" v-if='desk_pai[gameId][6][3]?true:false' :class='iszhuanged==6?  "_2Ntdh":""'>
       <span class="_3PXnW">{{desk_pai[gameId][1]['dian']}}<span>点</span></span>
      </div>
     </div>
    </div>
...
export default {
  ...
  data () {
    return {
      ...
      desk_result:{},
      pailist:pailist,
      desk_pai:{19:{1:{1:"",2:"",3:""},2:{1:"",2:"",3:""},3:{1:"",2:"",3:""},4:{1:"",2:"",3:""},5:{1:"",2:"",3:""},6:{1:"",2:"",3:""}}},
      num:0,
      ...
      imglist1 : {
        ...
        1: { image_url: './static/zuobu/sg_z1.png', x: 0, y: 200 },
        2: { image_url: './static/zuobu/sg_z2.png', x: 0, y: 200 },
        3: { image_url: './static/zuobu/sg_z3.png', x: 0, y: 200 },
        4: { image_url: './static/zuobu/sg_z4.png', x: 0, y: 200 },
        5: { image_url: './static/zuobu/sg_z5.png', x: 0, y: 200 },
        6: { image_url: './static/zuobu/sg_z6.png', x: 0, y: 200 },
      },
      images:{},
      _arr:[],
     local_list :{
     ...
     zhuang_position:{0:[1037,154],1:[1460,154],2:[1370,284],3:[1155,314],4:[935,310],5:[705,285],6:[617,150]},
     zhuang_all:['1','2','3','4','5','6'],
     iszhuanged:false,
     o:{},
     coinStack:{},
     failtxt:{},
  ...
  methods: {
    ...
    sandXiazhu:function(event){
      ...
      self.playGameEffect("./static/sound/se/click_btn.mp3",true)
      if(index==19){
          self.global.sendMessage("sangong_bet",{desk_id:index,bets:bet});
        }else{
    ...
    clearAll:function(vo){
      ...
      if(self.desk_pai[vo.desk_id]){
        self.$set(self.desk_pai,vo.desk_id,{1:{1:"",2:"",3:""},2:{1:"",2:"",3:""},3:{1:"",2:"",3:""},4:{1:"",2:"",3:""},5:{1:"",2:"",3:""},6:{1:"",2:"",3:""}})
      }
      //清理下注成功的结果
      if(self.desk_pai[vo.desk_id]){
  ...
  showXian: function () {
    console.log( "----showXian")
    var _this = this;
    this["xian_1"].animate('style', true)
      .delay(1000)
      .when(7000, { opacity: .5 })
      .start()
    this["xian_2"].animate('style', true)
      .delay(2000)
      .when(7000, { opacity: .5 })
      .start()
    this["xian_3"].animate('style', true)
      .delay(3000)
      .when(7000, { opacity: .5 })
      .start()
    this["xian_4"].animate('style', true)
      .delay(4000)
      .when(7000, { opacity: .5 })
      .start()
    this["xian_5"].animate('style', true)
      .delay(5000)
      .when(7000, { opacity: .5 })
      .start()
    this["xian_6"].animate('style', true)
      .delay(6000)
      .when(7000, { opacity: .5 })
      .start()
    },
    closeshowxian:function(){
      this["xian_1"].stopAnimation()
      this["xian_1"].attr({ style: { opacity: '0' } })
      this["xian_2"].stopAnimation()
      this["xian_2"].attr({ style: { opacity: '0' } })
      this["xian_3"].stopAnimation()
      this["xian_3"].attr({ style: { opacity: '0' } })
      this["xian_4"].stopAnimation()
      this["xian_4"].attr({ style: { opacity: '0' } })
      this["xian_5"].stopAnimation()
      this["xian_5"].attr({ style: { opacity: '0' } })
      this["xian_6"].stopAnimation()
      this["xian_6"].attr({ style: { opacity: '0' } })
    },
    closeshowzhuang:function(){
      this[1].stopAnimation()
      this[1].attr({ style: { opacity: '0' } })
      this[2].stopAnimation()
      this[2].attr({ style: { opacity: '0' } })
      this[3].stopAnimation()
      this[3].attr({ style: { opacity: '0' } })
      this[4].stopAnimation()
      this[4].attr({ style: { opacity: '0' } })
      this[5].stopAnimation()
      this[5].attr({ style: { opacity: '0' } })
      this[6].stopAnimation()
      this[6].attr({ style: { opacity: '0' } })
    },
    showZhuang: function (name) {
    console.log(name, "----showZhuang")
    var _this = this;
    if(_this.iszhuanged){return}
    this[1].animate('style', true)
      .when(6000, { opacity: .5 }).done(function () {
         _this[1].attr({ style: { opacity: 1 } })
       })
      .start()
    this[2].animate('style', true)
      .delay(1000)
      .when(6000, { opacity: .5 })
      .done(function () {
         _this[2].attr({ style: { opacity: 0 } })
       })
      .start()
    this[3].animate('style', true)
      .delay(2000)
      .when(6000, { opacity: .5 })
      .done(function () {
         _this[3].attr({ style: { opacity: 0 } })
       })
      .start()
    this[4].animate('style', true)
      .delay(3000)
      .when(6000, { opacity: .5 })
      .done(function () {
         _this[4].attr({ style: { opacity: 0 } })
       })
      .start()
    this[5].animate('style', true)
      .delay(4000)
      .when(6000, { opacity: .5 })
      .done(function () {
         _this[5].attr({ style: { opacity: 0 } })
       })
      .start()
    this[6].animate('style', true)
      .delay(5000)
      .when(6000, { opacity: .5 })
      .done(function () {
         _this[6].attr({ style: { opacity: 0 } })
       })
      .start()
    },
    startBet:function (vo){
      ...
      self.rightclass =''
      self.clearAll(vo)
      self.zrBGGroup.childOfName('zhuang').attr('position',[1037,154])
      self.showZhuang()
      self.zuobuevents();
    ...
    onSGResultHistory: function (vo) {
      var self = this
      self.leijidata = vo
      console.log("累计==" + JSON.stringify(vo))
    },
    onSGMoneyPool: function (vo) {
    ...
    init: function () {
      ...
      self.drawBG();
      if(self.desk_status[self.gameId]&&self.desk_status[self.gameId]['status']=='1'){
        self.showZhuang()
      }
  ...
  showResult: function (name) {
   ...
   // {0:[1037,154],1:[1460,154],2:[1370,284],3:[1155,314],4:[935,310],5:[705,285],6:[617,150]}
    this.zhuang = new zrender.Image({
      name: "zhuang",
      style: {
        image: "./static/zuobu/cb9adca2.png",
        width:96,
        height:64,
      },
    ...
    this[1] = new zrender.Image({
      style: {
        image: './static/zuobu/sg_z1.png',
        opacity: 0
      },
      position: [0, 0],
      cursor: 'default'
    ...
    this[2] = new zrender.Image({
      style: {
        image: './static/zuobu/sg_z2.png',
        opacity: 0
      },
      position: [0, 0],
      cursor: 'default'
    ...
    this[3] = new zrender.Image({
      style: {
        image: './static/zuobu/sg_z3.png',
        opacity: 0
      },
      position: [0, 0],
      cursor: 'default'
    ...
    this[4] = new zrender.Image({
      style: {
        image: './static/zuobu/sg_z4.png',
        opacity: 0
      },
      position: [0, 0],
      cursor: 'default'
    ...
    this[5] = new zrender.Image({
      style: {
        image: './static/zuobu/sg_z5.png',
        opacity: 0
      },
      position: [0, 0],
      cursor: 'default'
    });
    this[6] = new zrender.Image({
      style: {
        image: './static/zuobu/sg_z6.png',
        opacity: 0
      },
      position: [0, 0],
      cursor: 'default'
    ...
    this.zrBGGroup.add(this[1]);
    this.zrBGGroup.add(this[2]);
    this.zrBGGroup.add(this[3]);
    this.zrBGGroup.add(this[4]);
    this.zrBGGroup.add(this[5]);
    this.zrBGGroup.add(this[6]);

    this.zrBGGroup.add(this.zuobu2);
    this.drawzuobu('./static/zuobu/sg_name.png');
    ...
    zuobuclick:function(evt){
     // if(!this.zuobuevent){return}
      ...
      if(_this.zhuang_all.indexOf(curr_qu)!==-1){
          _this.zrBGGroup.childOfName('zhuang').attr('position',_this.zhuang_position[curr_qu])
          console.log({desk_id:_this.gameId,zhuang_men:"xian_"+curr_qu})
          _this.global.sendMessage("sangong_set_zhuang_men",{desk_id:_this.gameId,zhuang_men:"xian_"+curr_qu})
          _this.iszhuanged = curr_qu;
          _this.closeshowzhuang()
          _this.showXian()
        return
      }
  ...
  creatCanvas:function  (image_url, x, y, name) {
    ...
    onSGCard:function(vo){
     ...
     if(vo.men==1){
       self.$set(self.desk_pai[id][1],vo.order,self.pailist[vo.card])
       self.$set(self.desk_pai[id][1],"gong",vo.gong)
       self.$set(self.desk_pai[id][1],"dian",vo.dian)
     }
    if(vo.men==2){
       self.$set(self.desk_pai[id][2],vo.order,self.pailist[vo.card])
       self.$set(self.desk_pai[id][2],"gong",vo.gong)
       self.$set(self.desk_pai[id][2],"dian",vo.dian)
     }
     if(vo.men==3){
       self.$set(self.desk_pai[id][3],vo.order,self.pailist[vo.card])
       self.$set(self.desk_pai[id][3],"gong",vo.gong)
       self.$set(self.desk_pai[id][3],"dian",vo.dian)
     }
     if(vo.men==4){
       self.$set(self.desk_pai[id][4],vo.order,self.pailist[vo.card])
       self.$set(self.desk_pai[id][4],"gong",vo.gong)
       self.$set(self.desk_pai[id][4],"dian",vo.dian)
     } 
     if(vo.men==5){
       self.$set(self.desk_pai[id][5],vo.order,self.pailist[vo.card])
       self.$set(self.desk_pai[id][5],"gong",vo.gong)
       self.$set(self.desk_pai[id][5],"dian",vo.dian)
     }
     if(vo.men==6){
       self.$set(self.desk_pai[id][6],vo.order,self.pailist[vo.card])
       self.$set(self.desk_pai[id][6],"gong",vo.gong)
       self.$set(self.desk_pai[id][6],"dian",vo.dian)
     }         
     console.log(self.desk_pai)
      
    },
    onSGZhuang:function(vo){
      console.log(vo)
    },
    rePlay:function(){
  ...
  created () {
    ...
    self.onSGMoneyPool(self.$store.state.onSGMoneyPool);
    self.onSGResultHistory(self.$store.state.onSGResultHistory);
    self.EnterDesk()
    ...
    self.images = new Array();
            ...
            preLoadImg(    
                { 
                  0:"./static/zuobu/cb9adca2.png",  
                  38:"./static/zuobu/sg_name.png",  
                  39:"./static/zuobu/quejiu_desk.png", 
                  ...
                  1:"./static/zuobu/sg_z1.png",
                  2:"./static/zuobu/sg_z2.png",
                  3:"./static/zuobu/sg_z3.png",
                  4:"./static/zuobu/sg_z4.png",
                  5:"./static/zuobu/sg_z5.png",
                  6:"./static/zuobu/sg_z6.png",
  ...
  '$store.state.onSGZhuang':function(){var self = this;self.onSGZhuang(self.$store.state.onSGZhuang)},
  '$store.state.onMemberBet':function(){var self = this;self.onMemberBet(self.$store.state.onMemberBet)},
  '$store.state.onSGCard':function(){var self = this;self.onSGCard(self.$store.state.onSGCard)},
  '$store.state.onSGResult':function(){var self = this;self.onSGResult(self.$store.state.onSGResult)},
  ...
  '$store.state.onSGBetSuccess':function(){var self = this;self.onSGBetSuccess(self.$store.state.onSGBetSuccess)},
  '$store.state.onSGResultHistory': function () { var self = this; self.onSGResultHistory(self.$store.state.onSGResultHistory) },
  '$store.state.onSGMoneyPool': function () { var self = this; self.onSGMoneyPool(self.$store.state.onSGMoneyPool) },
...
@-webkit-keyframes _1fb3M{0%{-webkit-transform:rotateY(0deg);transform:rotateY(0deg)}to{-webkit-transform:rotateY(180deg);transform:rotateY(180deg)}}@keyframes _1fb3M{0%{-webkit-transform:rotateY(0deg);transform:rotateY(0deg)}to{-webkit-transform:rotateY(180deg);transform:rotateY(180deg)}}@-webkit-keyframes bHG5G{0%{background-position:100% 0,100% 100%,0 100%,0 0}50%{background-position:50% 0,100% 50%,50% 100%,0 50%}to{background-position:0 0,100% 0,100% 100%,0 100%}}@keyframes bHG5G{0%{background-position:100% 0,100% 100%,0 100%,0 0}50%{background-position:50% 0,100% 50%,50% 100%,0 50%}to{background-position:0 0,100% 0,100% 100%,0 100%}}._2h2Bz{-ms-flex-pack:distribute;justify-content:space-around;-ms-flex-direction:column;flex-direction:column;width:2.56em;background-color:#040403}._2gz6c,._2h2Bz,._3jBHi,.EjgZS{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}._2gz6c,._3jBHi,.EjgZS{-ms-flex-pack:center;justify-content:center}._1-x-E{display:-ms-flexbox;display:flex;width:2.56em;height:.33em;border-bottom:.01em solid #24211a}._2gz6c{width:2.57143em;color:#bbaa7d}._2gz6c,.EjgZS{font-size:.14em}.EjgZS{width:2.71429em;color:hsla(0,0%,100%,.87)}._1ocfm{width:1.82em;padding:0 .06em;display:-ms-flexbox;display:flex;-ms-flex-pack:distribute;justify-content:space-around;-ms-flex-align:center;align-items:center}._1ocfm ._3jBHi{width:1.85714em;height:1.85714em;border-radius:50%;background:#ff101a;color:hsla(0,0%,100%,.87);padding-bottom:.21429em;font-size:.14em}._1ocfm ._2ntAb{background:#7d7254 url(data:image/png;base64,) no-repeat 50%;background-size:1.28571em 1.28571em}
._1DTtZ{position:absolute;top:0;bottom:0;left:0;right:0;pointer-events:auto}
@-webkit-keyframes _19Tq6{0%{-webkit-transform:rotateY(0deg);transform:rotateY(0deg)}to{-webkit-transform:rotateY(180deg);transform:rotateY(180deg)}}@keyframes _19Tq6{0%{-webkit-transform:rotateY(0deg);transform:rotateY(0deg)}to{-webkit-transform:rotateY(180deg);transform:rotateY(180deg)}}@-webkit-keyframes _3Y891{0%{background-position:100% 0,100% 100%,0 100%,0 0}50%{background-position:50% 0,100% 50%,50% 100%,0 50%}to{background-position:0 0,100% 0,100% 100%,0 100%}}@keyframes _3Y891{0%{background-position:100% 0,100% 100%,0 100%,0 0}50%{background-position:50% 0,100% 50%,50% 100%,0 50%}to{background-position:0 0,100% 0,100% 100%,0 100%}}._3495p{position:relative;width:100%;height:100%}._19yHq{position:absolute}._19yHq.IBoJx{top:0;right:0}._19yHq._297ix{top:1.15em;right:.86em}._19yHq._5ekkN{top:1.67em;right:2.94em}._19yHq.CP_N5{top:1.67em;left:2.94em}._19yHq._1DEQ8{top:1.15em;left:.94em}._19yHq.uEIjy{top:0;left:0}.LKrbW{display:-ms-flexbox;display:flex}.LKrbW ._2iVV0{width:.4em;height:.59em;margin-right:.04em}.P0PGl{opacity:0}.kUfzd{width:1.25em;height:.3em;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;padding-bottom:.02em;margin-top:.08em;margin-left:.02em;-webkit-box-sizing:border-box;box-sizing:border-box;border-radius:.03em;border:.01em solid rgba(84,129,241,.5);background-image:radial-gradient(#2870ff 0,#144bb7 63%)}.kUfzd._2Ntdh{border-radius:.03em;border:.01em solid hsla(0,100%,84%,.5);background-image:radial-gradient(#f36868 0,#ea1323 63%)}.kUfzd ._3PXnW{font-size:.16em;font-weight:600;color:hsla(0,0%,100%,.87)}._2528t{display:inline-block;margin-right:.3125em}
</style>
